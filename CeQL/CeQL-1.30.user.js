...
//                 saveStakeouts();
    ...
    function processfightResultsPage() {
        ...
        function doAddEnemiesBtn() {
            ...
            $(".addEnemiesBtn-wrap").css("display", (chk ? "flex" : "none"));
        }
...
//             }
            ...
            const enemiesBtn = `<span class="addEnemiesBtn-wrap"><a href="/Connections?t=enemies"><button id="addEnemiesBtn" class="btn btn-sm btn-dark">Enemies</button></a></span>`;
