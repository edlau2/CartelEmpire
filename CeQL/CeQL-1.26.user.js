...
//                                           " valid? ", (options[key] ? isValid(options[key][pkey]) : false));
    ...
    const dbStores = {
        ...
        "eventsStore": { "name": eventsStoreName, "indexes": ["category"], "keypath": "id", "active": true },
    };
...
//         if ($(ca).length) {cl = getClassList($(ca));}
    ...
    */
    ...
    function filterSellItemList(retries=0) {
        ...
        const btnSpan = `<div><span id="show-filt" class="fbtn">Filters</span></div>`;
        const filtRow = `<div id="sell-filters" class="row mb-0" style="display: none;">
                             <div class="col-12">
                                 <div class="header-section" style="position: relative;">
                                     <span class='sfilter'>
                                         <label>Prod<input type="checkbox" name="prod"></label>
                                         <label>Weap<input type="checkbox" name="weap"></label>
                                         <label>Armor<input type="checkbox" name="armor"></label>
                                         <label>Cons<input type="checkbox" name="cons"></label>
