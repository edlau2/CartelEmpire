...
//                                           " valid? ", (options[key] ? isValid(options[key][pkey]) : false));
    ...
    const defOptions = {
        ...
        "addEnemiesBtn":       { "on": true, "desc": "Add 'Enemies' link to fight results page", "visible": true, "grp": "cbt" },
    ...
    // TEMP - put somewhere, for missions page
    GM_addStyle(` .mission-progress > .progress-bar { color: black; } .mission-progress > .progress-bar:hover { font-size: large; }`);
...
//             }
            ...
            const searchBtn = `<span class="enemiesBtn-wrap"><a href="">
