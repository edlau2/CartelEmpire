...
(function() {
    ...
    const chatOpacity = '80';    // 50% opacity in hex
...
/*         Change $("input.userMessage") to 'type="textarea"', not text
    ...
    function checkStatusIcons() {
        ...
        $(privateChats).each(function(idx, el) {
            ...
            log("xxx [checkStatusIcons] savedChatDates[chatId]: ", chatId, savedChatDates[chatId]);
            ...
            log("yyz [checkStatusIcons] from ", name, " lastMsgNode: ", $(lastMsgNode), " from me: ", lastIsMine);
...
//         }
        ...
        GM_addStyle(`
            ...
            .xlg {
                ...
                background: linear-gradient(to bottom, #b4ddb4${chatOpacity} 0%, #83c783${chatOpacity} 12%,#52b152${chatOpacity} 25%,#52b152${chatOpacity} 50%,#008a00${chatOpacity} 76%,#005700${chatOpacity} 91%,#002400${chatOpacity} 100%);
            }
            .xlb {
                /*background: linear-gradient(to bottom, #4c4c4c 0%,#595959 12%,#666666 25%,#2c2c2c 50%,#111111 50%,#2b2b2b 76%,#1c1c1c 91%,#131313 100%);*/
                background: linear-gradient(to bottom, #4c4c4c${chatOpacity} 0%,#595959${chatOpacity} 12%,#666666${chatOpacity} 25%,#2c2c2c${chatOpacity} 50%,#2b2b2b${chatOpacity} 76%,#1c1c1c${chatOpacity} 91%,#131313${chatOpacity} 100%);
            }
            .xlb:hover, .xlg:hover {
